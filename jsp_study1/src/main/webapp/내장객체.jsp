...
<%--
	JSP 페이지를 생성하고 서버의 의해 페이지가 동작할 때,
	서버에서 페이지에게 객체를 할당해준다. 
	
	내장객체는 9가지.
		서버 - application: 처음 서버가 시작할 때 생성되는 객체
		연결 - session : 사용자가 서버에 처음 요청 할 때 생성되고 
						사용자가 브라우저를 종료하기전까지 살아있는 객체 
...
<body>
	...
	<% 
		...
		out.println(request.getLocale()); // 국가 코드 
	...
	%>
	<!-- input태그에 입력한 내용에대한 처리를 requestTest.jsp 
		 주소로 요청  -->
