...
<%--  useBean
		...
		scope=""/ 스코프에 넣어주지 않는다면 현재 이 페이지 객체에 저장된다. 
...
<jsp:useBean id="music" class="test.Music" />   <%-- 이 에러가 사라지지 않는건 이클립스 자체 문제  --%>
